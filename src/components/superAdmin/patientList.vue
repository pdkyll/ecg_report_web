    ...
    <el-row class="warpSuper">
        ...
        <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
                ...
                <el-form :inline="true" :model="filters" :rules="searchReportsFormRules" ref="searchReportsForm">
                    ...
                    <el-form-item label="报告ID：" prop="id">
                        <el-input v-model.trim="filters.id" placeholder="请输入" class="select-common"
                            ...
                            <i slot="suffix" class="el-input__icon el-icon-error"
                               v-if="filters.id!==''" style="cursor: pointer;" @click="filters.id = '';handleSearch(null, false);"></i>
                        </el-input>
                    </el-form-item>
                    <el-date-picker
            ...
            >
                ...
                <el-table-column prop="report_hospital" label="所属医院" sortable="custom" width="120">
                </el-table-column>
    ...
    export default {
        ...
        mounted() {
            ...
            if (reportId) {
                ...
                if (this.$route.params.deleted) {
                    this.filters.report_states = 'DELETED';
                }
                this.filters = {
                    ...this.filters,
                    id: reportId
                };
                bus.$emit('changeSelectIndex', "0");
            }
