...
var wasmBinaryFile = 'qrs_renderer_util.wasm';
...
var real__accumulate = asm["_accumulate"];
asm["_accumulate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__accumulate.apply(null, arguments);
};
...
var real__linearInterpolate = asm["_linearInterpolate"];
asm["_linearInterpolate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__linearInterpolate.apply(null, arguments);
};
...
var _accumulate = Module["_accumulate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_accumulate"].apply(null, arguments)
};
...
var _linearInterpolate = Module["_linearInterpolate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_linearInterpolate"].apply(null, arguments)
};
